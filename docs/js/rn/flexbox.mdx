...
<img alt="RN的FlexBox" src={useBaseUrl('/images/rn/flexbox01.png')} />
...
<img alt="flexwarp" src={useBaseUrl('/images/rn/flexbox02.png')} />
...
<img alt="justifyContent" src={useBaseUrl('/images/rn/flexbox03.png')} />

flex-end 从右边对齐
space-around 两边对齐, 两边的边距刚好是两个元素中间的距离的一半

<img alt="space-around" src={useBaseUrl('/images/rn/flexbox04.png')} />

space-between 两边对齐

<img alt="space-between" src={useBaseUrl('/images/rn/flexbox05.png')} />
...
<img alt="alignitems" src={useBaseUrl('/images/rn/flexbox06.png')} />
...
<img alt="alignSelf" src={useBaseUrl('/images/rn/flexbox07.png')} />
