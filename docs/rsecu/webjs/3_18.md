...
```js
const _0x3dc5 = ['log'];
(function (_0x1ac523, _0x3dc552) {
    const _0x5713d2 = function (_0x21c759) {
        while (--_0x21c759) {
            _0x1ac523['push'](_0x1ac523['shift']());
        }
    };
    _0x5713d2(++_0x3dc552);
}(_0x3dc5, 0xd4));
const _0x5713 = function (_0x1ac523, _0x3dc552) {
    _0x1ac523 = _0x1ac523 - 0x0;
    let _0x5713d2 = _0x3dc5[_0x1ac523];
    return _0x5713d2;
};
let x = '1' + 0x1;
console[_0x5713('0x0')]('x', x);
```
...
```js
const _0x1327=['log'];(function(_0x29eb7a,_0x1327a9){const _0x37aed6=function(_0x1d9f0d){while(--_0x1d9f0d){_0x29eb7a['push'](_0x29eb7a['shift']());}};_0x37aed6(++_0x1327a9);}(_0x1327,0x114));const _0x37ae=function(_0x29eb7a,_0x1327a9){_0x29eb7a=_0x29eb7a-0x0;let _0x37aed6=_0x1327[_0x29eb7a];return _0x37aed6;};let x='1'+0x1;console[_0x37ae('0x0')]('x',x);
```
...
`
const options = {
    domainLock: ['baidu.com'] // 如果自己要本地试验的话，可以写成127.0.0.1，如有自己的域名就改成自己的域名就写了。
}
```
运行结果如下：
...
```
这段代码就只能在指定域名 baidu.com 下运行，不能在其他网站运行。

如果自己要本地试验的话，可以写成127.0.0.1，如有自己的域名就改成自己的域名就写了。
...
### WebAssembly
前面提到过WebAssembly，可以返回去看，WebAssembly是将 C/C++ 转成 JavaScript 引擎可以运行的代码。那么它与 asm.js 有何区别呢？
...
https://www.cnblogs.com/xwltest/p/17660103.html

https://blog.csdn.net/weixin_52001594/article/details/135970409

这里有一个OB混淆还原破解的工具供参考，读一下他的自述文件就会用了。网上还有很多类似的工具，很多都是可以拿来用的。一般github上会有很多。当然了，也可以自己写一个这样的破解工具（用Python或者Node，加上各自语言的qt的界面库就行了，又或者直接用webview当界面和底层的Python和Nodejs交互也是可以的）。
