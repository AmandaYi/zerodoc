...
![ssh key](/images/go_zero/ssh-add-key.png)
...
![jenkins-git](/images/go_zero/jenkins-git.png)


![jenkins-configure](/images/go_zero/jenkins-configure.png)
...
* 获取凭据id 进入凭据页面，找到Username为`gitlab`的凭据id
  ![jenkins-credentials-id](/images/go_zero/jenkins-credentials-id.png)

* 进入jenkins首页，点击`新建Item`，名称为`user`
  ![jenkins-add-item](/images/go_zero/jenkins-new-item.png)

* 查看项目git地址
  ![gitlab-git-url](/images/go_zero/gitlab-git-url.png)
...
* 添加服务类型Choice Parameter,在General中勾选`This project is parameterized
  ...
  ![jenkins-choice-parameter](/images/go_zero/jenkins-choice.png)
...
![user-pipepine-script](/images/go_zero/user-pipeline-script.png)
:::
...
## 查看pipeline
![build with parameters](/images/go_zero/jenkins-build-with-parameters.png)
![build with parameters](/images/go_zero/pipeline.png)

## 查看k8s服务
![k8s01](/images/go_zero/k8s-01.png)
